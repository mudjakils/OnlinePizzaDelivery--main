...
<html lang="en">
  ...
  <?php include 'partials/_nav.php';?>
                    ...
                    echo '<div class="col-lg-4 bg-image" style="background-image:url(img/contact.jpg)">
                          <div class="detail-box p-4">
                            ...
                            <div class="round-social light">
                              <a href="https://mail.google.com/mail/u/0/#inbox' .$email. '" class="ml-0 text-decoration-none text-white border border-white rounded-circle" target="_blank"><i class="far fa-envelope"></i></a>
                              <a href="https://github.com/mudjakils" class="text-decoration-none text-white border border-white rounded-circle" target="_blank"><i class="fab fa-github"></i></i></a>
                              <a href="https://www.youtube.com/@reggiemadrijanon822" class="text-decoration-none text-white border border-white rounded-circle" target="_blank"><i class="fab fa-youtube"></i></a>
                            </div>
                          </div>
                        </div>';
                  ?>
      ...
      <!-- Message Modal -->
      <div class="modal fade" id="adminReply" tabindex="+63" role="dialog" aria-labelledby="adminReply" aria-hidden="true">
            ...
            <div class="modal-body" id="bd">
              <table class="table-striped table-bordered col-md-12 text-center">
                ...
                <?php 
                    ...
                    if($count==0) {
                      ?><script> document.getElementById("bd").innerHTML = '<div class="my+63">you have not contacted us.</div>';</script> <?php
                    }    
                ?>
                </tbody>
		          </table>
