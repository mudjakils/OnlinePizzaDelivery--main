      ...
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Welcome to <span>Pizza </span></h2>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown mb-0">REGGIE MADJRIJANON(MUDJA)</h2><p>CE084 <a href="https://github.com/mudjakils" target="_blank">https://github.com/mudjakils</a></p>
                <a href="index.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Get Started</a>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row" style="padding-left: 228px;">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.1s">
            <div class="member">
              <img src="assets/img/team/reggie2.jpg" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>GWAPO</h4>
                </div>
                <div class="social">
                  <a href="https://www.facebook.com/reggiegonzaga123/" target="_blank"><i class="icofont-facebook"></i></a>
                  <a href="https://github.com/mudjakils" target="_blank"><i class="fab fa-github"></i></a>
                  <a href="" target="_blank"><i class="" target=""></i></a>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-xl-3 col-lg-4 col-md-6" data-wow-delay="0.2s">
            <div class="member">
              <img src="assets/img/team/carmarian.jpg" class="img-fluid" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>GWAPA</h4>
                </div>
                <div class="social">
                <a href="https://www.facebook.com/mgilestrada" target="_blank"><i class="icofont-facebook"></i></a>
                  <a href="" target="_blank"><i class=""></i></a>
                  <a href="https://www.youtube.com/@mariannegilestrada343">youtube<i class=""icofont-Youtube""></i></a>
                </div>
              </div>
            </div>
          </div>
