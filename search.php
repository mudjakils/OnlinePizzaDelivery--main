                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <a href="viewPizzaList.php?catid=' . $catId . '" class="btn btn-outline-info">View All</a>
                        </div>
                    </div>
                </div>';
            }
                            ...
                            <div class="row justify-content-center">';
                                if($loggedin){
                                    ...
                                    if($quaExistRows == 0) {
                                        ...
                                        echo '<a href="viewCart.php"><button class="btn btn-outline-info">Go to Cart</button></a>';
                                    }
                                }
                                else{
                                    echo '<button class="btn btn-outline-info" data-toggle="modal" data-target="#loginModal">Add to Cart</button>';
                                }
                                echo '</form>
                                <a href="viewPizza.php?pizzaid=' . $pizzaId . '"><button class="btn btn-outline-info">Quick View</button></a>
                            </div>
                        </div>
                    </div>
                </div>';
